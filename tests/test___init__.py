...
from tests.testlibraries.parametrizer.file_path_with_resource_factories import FilePathWithFileFactory, \
...
PARAMS = [
    ...
    (TwS(FPS.NOT_EXIST, FPS.BACKUP),                    Act.VACATE_TARGET_IF_EXIST_ASSERT_ERROR,    TwS(FPS.NOT_EXIST,  FPS.BACKUP)),                       # noqa E501
    ...
    (ThS(FPS.EXISTING,  FPS.NOT_EXIST,  FPS.RESOURCE),  Act.DEPLOY_RESOURCE,                        ThS(FPS.RESOURCE,   FPS.EXISTING,   FPS.RESOURCE)),     # noqa E501
    (ThS(FPS.NOT_EXIST, FPS.NOT_EXIST,  FPS.RESOURCE),  Act.DEPLOY_RESOURCE,                        ThS(FPS.RESOURCE,   FPS.NOT_EXIST,  FPS.RESOURCE)),     # noqa E501
    (ThS(FPS.NOT_EXIST, FPS.NOT_EXIST,  FPS.NOT_EXIST), Act.DEPLOY_RESOURCE_ASSERT_ERROR,           ThS(FPS.NOT_EXIST,  FPS.NOT_EXIST,  FPS.NOT_EXIST)),    # noqa E501
    ...
    # test_setup
    (ThS(FPS.EXISTING,  FPS.NOT_EXIST,  FPS.RESOURCE),  Act.DEPLOYER_SETUP,                         ThS(FPS.RESOURCE,   FPS.EXISTING,   FPS.RESOURCE)),     # noqa E501
    (ThS(FPS.EXISTING,  FPS.NOT_EXIST,  FPS.RESOURCE),  Act.DEPLOYER_SETUP_WITH_ARGUMENT,           ThS(FPS.RESOURCE,   FPS.EXISTING,   FPS.RESOURCE)),     # noqa E501
    # test_teardown (integration test)
    (ThS(FPS.EXISTING,  FPS.BACKUP,     FPS.RESOURCE),  Act.DEPLOYER_TEARDOWN,                      ThS(FPS.BACKUP,     FPS.NOT_EXIST,  FPS.RESOURCE)),     # noqa E501
    (ThS(FPS.EXISTING,  FPS.NOT_EXIST,  FPS.RESOURCE),  Act.DEPLOYER_TEARDOWN,                      ThS(FPS.EXISTING,   FPS.NOT_EXIST,  FPS.RESOURCE)),     # noqa E501
]
